...
import (
	...
	"github.com/fadeedan/pipo_hse_2026/internal/auth"
...
func main() {
	...
	tokens := jwt.NewManager(cfg.JWTSecret, cfg.AppName, cfg.TokenTTL)
	...
	go func() {
		logger.Info("auth service started", "addr", srv.Addr)
